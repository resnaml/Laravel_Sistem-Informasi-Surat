    ...
    <div class="d-flex">
        <form action="/seluruhsurat" role="search">
            <div class="d-flex btn">
                <input class="mb-3 form-control mr-3" name="search" type="search">
        ...
        <div class="row2">
            <a class="d-flex btn btn-success ml-3 mr-3 mt-2" onclick="this.href='/seluruhsurat/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"><i class="bi bi-printer"> Cari data</i></a>
        </div>
        <div class="row2">
